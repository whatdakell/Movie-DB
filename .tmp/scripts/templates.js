  ...
  l["detail.hbs"] = a({
    ...
    main: function (a, l, e, n) {
      ...
      return '<iframe class="bg-image" width="100vh" height="100%" src="http://www.youtube.com/embed/' + o(s(null != (t = null != (t = null != (t = null != a ? a.videos : a) ? t.results : t) ? t["0"] : t) ? t.key : t, a)) + '?autoplay=1&controls=0&showinfo=0&loop=1&autohide=1&mute=1" frameborder="0" allowfullscreen autoplay></iframe>\n<div class="box-content">\n		<div class="box-info">\n				<h1>' + o((i = null != (i = l.title || (null != a ? a.title : a)) ? i : d, typeof i === r ? i.call(a, {
        ...
        hash: {},
        data: n
      }) : i)) + '</p>\n						<a class="goBack" data-key=' + o((i = null != (i = l.id || (null != a ? a.id : a)) ? i : d, typeof i === r ? i.call(a, {
        name: "id",
        hash: {},
        data: n
      }) : i)) + ">Go Back</a>\n					</div>\n				</div>\n		</div>\n</div>\n";
    ...
    main: function (a, l, e, n) {
      var t,
          ...
          s = l.helperMissing,
          o = this.escapeExpression;
      return "\n<div style=\"background-image: url('http://image.tmdb.org/t/p/original/" + o((t = null != (t = l.backdrop_path || (null != a ? a.backdrop_path : a)) ? t : s, typeof t === i ? t.call(a, {
        name: "backdrop_path",
        hash: {},
        data: n
    ...
    1: function (a, l, e, n) {
      var t,
          ...
          d = '	<!-- <div>p</div> -->\n		<div class="content-box" data-attribute=' + r((i = null != (i = l.id || (null != a ? a.id : a)) ? i : o, typeof i === s ? i.call(a, {
        name: "id",
        hash: {},
        data: n
      }) : i)) + " >\n";
      return t = this.invokePartial(e["gallery-item"], "			", "gallery-item", a, void 0, l, e, n), null != t && (d += t), d + "		</div>\n";
    },
    compiler: [6, ">= 2.0.0-beta.1"],
    main: function (a, l, e, n) {
      var t,
